...
const zh: Dict = {
  ...
  'search.stayMin': '最短',
  'search.stayMax': '最长',
  'countryPref.searchTitle': '中转国家偏好',
  'countryPref.searchHint': '优先推荐参与综合排序，完全排除会直接过滤',
  'countryPref.add': '＋ 添加',
  'countryPref.manage': '管理',
  'countryPref.empty': '尚未设置，系统将综合价格、时长和衔接风险推荐',
  'countryPref.title': '选择中转国家偏好',
  'countryPref.subtitle': '从热门国家快速选择，或检索完整机场目录',
  'countryPref.searchPlaceholder': '搜索国家 / 城市 / 机场 / IATA',
  'countryPref.selected': '已设置',
  'countryPref.hot': '热门中转国家',
  'countryPref.results': '搜索结果',
  'countryPref.noResults': '没有找到匹配的国家或机场',
  'countryPref.neutral': '不限',
  'countryPref.preferred': '倾向',
  'countryPref.excluded': '禁止',
  'interest.food': '🍜 美食',
  'interest.culture': '🏛 文化',
  'interest.nature': '🌿 自然',
  ...
  'sp.filtered': '有 {n} 个方案被预算、中转方式或国家偏好隐藏',
  'sp.relax': '放宽筛选查看全部',
  ...
  'fcc.preferredCountryReason': '符合偏好：经您倾向的{country}中转，已提升推荐优先级',
  ...
  'chat.historyEmpty': '还没有保存的会话',
  'chat.historyNew': '新建会话',
  'chat.historyClose': '收起',
  'chat.historyDelete': '删除',
  'chat.historyDeleteTitle': '删除这段会话？',
  'chat.historyDeleteConfirm': '删除后无法恢复，仅影响本机记录。',
  'chat.historyUntitled': '未命名行程',
  'chat.historyCurrent': '当前',
  'chat.historyLocal': '仅保存在本机',
  'chat.understandingTitle': '当前理解',
  'chat.newTrip': '新行程',
  'chat.understandingUnset': '未定',
  'chat.understandingOrigin': '出发地',
  'chat.understandingDate': '日期',
  'chat.understandingDays': '天数',
  'chat.understandingBudget': '预算',
  'chat.understandingRegions': '区域',
  'chat.understandingInterests': '兴趣',
  'chat.understandingMustVisit': '必去城市',
  'chat.understandingExcluded': '排除城市',
  'chat.regionJapan': '日本',
  ...
  'chat.guideTitle': '行程攻略',
  'chat.guideDaysCount': '{n} 天 · 按路线整理',
  'chat.guideDay': '第 {n} 天',
  'chat.guideSources': '来源参考',
  'chat.guideSourceWeb': '网页摘要',
  'chat.guideSourceCatalog': '目的地目录',
  'chat.guideSourceRules': '规则建议',
  'chat.guideCopy': '复制链接',
  'chat.guideCopied': '链接已复制',
  'chat.guideCopyFailed': '复制失败，请稍后重试',
  'chat.warningGuideSearchUnavailable': '网页攻略搜索不可用，已改用目录建议。',
  'chat.warningGuideSearchPartial': '部分网页攻略搜索失败，已用目录建议补齐。',
  'chat.warningGuideSearchFailed': '网页攻略搜索失败，已改用目录建议。',
  'chat.warningGuideCatalogFallback': '当前攻略来自目的地目录，具体开放信息请出发前核实。',
  'chat.warningGuidePartialCatalogFallback': '部分攻略来自目的地目录，具体开放信息请出发前核实。',
  'chat.warningGuideLlmFallback': '攻略编辑服务不可用，已保留来源标注的基础安排。',
  'chat.warningGuideFallback': '攻略暂以安全的基础安排呈现。',
  ...
  'login.success': '登录成功',
  'login.fail': '登录失败，请重试',
  'login.notConfigured': '微信登录尚未配置，请联系开发者补齐登录配置。',
  'login.wechatRejected': '微信未接受本次登录，请重新登录；持续失败请联系开发者检查微信配置。',
  'login.localDisabled': '本地测试登录未启用，请检查本地开发服务。',
  'login.localRejected': '本地测试登录未通过验证，请重新配置本地测试入口。',
  'login.localConfirm': '本地测试登录',
  'login.localDesc': '独立测试账号，使用真实后端；仅供本机开发测试。',
  'login.localSuccess': '已登录本地测试账号',
  'login.localAccount': '本地测试账号 · 行程保存在当前开发后端',
...
const en: Dict = {
  ...
  'search.stayMin': 'Min',
  'search.stayMax': 'Max',
  'countryPref.searchTitle': 'Transit country preferences',
  'countryPref.searchHint': 'Preferred countries affect ranking; blocked countries are filtered out',
  'countryPref.add': '＋ Add',
  'countryPref.manage': 'Manage',
  'countryPref.empty': 'No preferences yet; recommendations balance price, duration, and connection risk',
  'countryPref.title': 'Transit country preferences',
  'countryPref.subtitle': 'Choose a popular country or search the full airport directory',
  'countryPref.searchPlaceholder': 'Search country / city / airport / IATA',
  'countryPref.selected': 'Selected',
  'countryPref.hot': 'Popular transit countries',
  'countryPref.results': 'Search results',
  'countryPref.noResults': 'No matching country or airport',
  'countryPref.neutral': 'Any',
  'countryPref.preferred': 'Prefer',
  'countryPref.excluded': 'Block',
  'interest.food': '🍜 Food',
  ...
  'sp.filtered': '{n} options hidden by budget, transfer, or country preferences',
  ...
  'sp.sortRecommended': 'Recommended',
  ...
  'fcc.preferredCountryReason': 'Matches your preference: transfer in {country}, ranked higher',
  ...
  'chat.historyTitle': 'Saved trips',
  'chat.historyEmpty': 'No saved trips yet',
  'chat.historyNew': 'New trip',
  'chat.historyClose': 'Close',
  'chat.historyDelete': 'Delete',
  'chat.historyDeleteTitle': 'Delete this trip?',
  'chat.historyDeleteConfirm': 'This cannot be undone and only removes the local copy.',
  'chat.historyUntitled': 'Untitled trip',
  'chat.historyCurrent': 'Current',
  'chat.historyLocal': 'Saved on this device',
  'chat.understandingTitle': 'Current understanding',
  'chat.newTrip': 'New trip',
  'chat.understandingUnset': 'Not set',
  'chat.understandingOrigin': 'From',
  'chat.understandingDate': 'Dates',
  'chat.understandingDays': 'Days',
  'chat.understandingBudget': 'Budget',
  'chat.understandingRegions': 'Regions',
  'chat.understandingInterests': 'Interests',
  'chat.understandingMustVisit': 'Must-visit',
  'chat.understandingExcluded': 'Excluded',
  ...
  'chat.guideTitle': 'Trip guide',
  'chat.guideDaysCount': '{n} days · arranged by route',
  'chat.guideDay': 'Day {n}',
  'chat.guideSources': 'Sources',
  'chat.guideSourceWeb': 'Web summary',
  'chat.guideSourceCatalog': 'Destination catalog',
  'chat.guideSourceRules': 'Rules guidance',
  'chat.guideCopy': 'Copy link',
  'chat.guideCopied': 'Link copied',
  'chat.guideCopyFailed': 'Could not copy the link',
  'chat.warningGuideSearchUnavailable': 'Web guide search is unavailable; using catalog guidance.',
  'chat.warningGuideSearchPartial': 'Some web guide searches failed; catalog guidance fills the gaps.',
  'chat.warningGuideSearchFailed': 'Web guide search failed; using catalog guidance.',
  'chat.warningGuideCatalogFallback': 'This guide uses destination-catalog guidance; verify access details before departure.',
  'chat.warningGuidePartialCatalogFallback': 'Some guide entries use destination-catalog guidance; verify access details before departure.',
  'chat.warningGuideLlmFallback': 'Guide editing is unavailable; the source-labelled basic plan is kept.',
  'chat.warningGuideFallback': 'The guide is shown as a safe basic plan for now.',
  ...
  'login.notConfigured': 'WeChat sign-in has not been configured. Please contact the developer.',
  'login.wechatRejected': 'WeChat rejected this sign-in. Retry, or ask the developer to check the WeChat configuration.',
  'login.localDisabled': 'Local test sign-in is disabled. Check the local development server.',
  'login.localRejected': 'Local test sign-in was rejected. Reconfigure the local test connection.',
  'login.localConfirm': 'Local test sign-in',
  'login.localDesc': 'Separate test account on the real backend. For local development only.',
  'login.localSuccess': 'Signed in locally',
  'login.localAccount': 'Local test account · Trips saved on this development backend',
