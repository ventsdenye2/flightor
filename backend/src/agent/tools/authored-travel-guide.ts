...
function classify(code: string): GuideRepairIssue['classification'] {
  ...
  if (/^guide_research_type:|eligible_research_evidence|verified_evidence|research_travel_window|supporting_evidence_(stale|unverified)/.test(code)) return 'evidence_missing'
